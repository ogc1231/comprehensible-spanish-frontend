...
*/
function ModalDelete({show,  handleClose, onConfirm, title }) {
  return (
    <Modal className={styles.ModalAlert} show={show} onHide={handleClose} onClose={handleClose}>
    <Modal.Header closeButton>
    <Modal.Title>Do you want to delete this {title}?</Modal.Title>
        </Modal.Header>
        <Modal.Body>Click delete button below to confirm</Modal.Body>
    <Modal.Footer>
